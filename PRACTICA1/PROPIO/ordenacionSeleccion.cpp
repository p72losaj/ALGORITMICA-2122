...
void ordenacionSeleccion(){
    ...
    escribeFicheroTiemposReales("datosRealesOrdenacionSeleccion.txt",numeroElementos, tiemposReales);
    ...
    escribeFicheroTiemposEstimados("datosFinalesOrdenacionSeleccion.txt",numeroElementos, tiemposReales, tiemposEstimados);
