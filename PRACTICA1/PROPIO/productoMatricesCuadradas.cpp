...
void productoMatricesCuadradas(){
    int orden_min; // Orden minimo de las matrices
    int orden_max; // Orden maximo de las matrices
    ...
    escribeFicheroTiemposReales("datosRealesProductoMatrices.txt",numeroElementos, tiemposReales);

    // Llamamos a la funcion de ajuste polinomico

    ajustePolinomico(numeroElementos,tiemposReales,a);

    // Calculamos los tiempos estimados de la funcion de ajuste de un polinomio
    ...
    escribeFicheroTiemposEstimados("datosFinalesProductoMatrices.txt",numeroElementos, tiemposReales, tiemposEstimados);
